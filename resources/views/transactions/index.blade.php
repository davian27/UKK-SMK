            ...
            <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body text-center">
                                        <img src="{{ asset('storage/' . $transaction->proofs) }}" class="img-fluid rounded" alt="Bukti Transaksi">
                                    </div>
                                    <div class="modal-footer">
                                        <a href="{{ asset('storage/' . $transaction->proofs) }}" class="btn btn-primary" download>Download</a>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" name="proofs" id="proofs" class="form-control">
                                                @if($transaction->proofs)
                                                <p class="mt-2">Bukti saat ini: <a href="{{ asset('storage/' . $transaction->proofs) }}" target="_blank">Lihat Bukti</a></p>
                                                @endif
                                            </div>
                        ...
                        <div class="modal fade" id="accTransactionModal{{ $transaction->id }}" tabindex="-1" aria-labelledby="accTransactionModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="accTransactionModalLabel">Konfirmasi Transaksi</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
